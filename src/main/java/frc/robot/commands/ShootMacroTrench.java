...
public class ShootMacroTrench extends CommandBase {
  private final Intake _intake;
  private final Magazine _magazine;
  private final Shooter _shooter;
  private final Transition _transition;
  private double _shooterSpeed = .5;
  private CommandBase _driveLimelightTrench;
  /**
   * Creates a new ShootMacro.
   */
  public ShootMacroTrench(Intake intake, Magazine magazine, Shooter shooter, Transition transition, CommandBase driveLimelightTrench) {
